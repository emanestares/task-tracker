...
const features = [
  {
    ...
    desc: 'Organize, prioritize and track every task with ease.',
  },
  {
    icon: BarChart3,
    title: 'Progress Insights',
    desc: 'Visual dashboards to keep your team on track.',
  },
  {
    icon: Users,
    title: 'Team Collaboration',
    desc: 'Role-based access for seamless teamwork.',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="absolute bottom-1/4 right-0 w-64 h-64 rounded-full blur-3xl opacity-15"
          style={{
