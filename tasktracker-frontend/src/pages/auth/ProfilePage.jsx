          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`input-field pr-10 ${pwdErrors.currentPassword ? 'error' : ''}`}
                placeholder="••••••••"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`input-field pr-10 ${pwdErrors.newPassword ? 'error' : ''}`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`input-field pr-10 ${pwdErrors.confirmPassword ? 'error' : ''}`}
